...
export function ChamarGarcom({ token, jaChamou }: { token: string; jaChamou: boolean }) {
  ...
  return (
    <button
      ...
      // mesa cheia de copo.
      className="mt-12 w-full max-w-xs rounded-xl bg-orange-700 px-8 py-8 text-2xl font-bold text-white transition hover:bg-orange-600 active:scale-95 disabled:opacity-50"
    >
